...
async function parsingItemList(categoryList: Array<string>, detailPage: any, pageNum: number, coltBaseUrlList: Array<ColtBaseUrlItem>): Promise<void> {
    ...
    detailPage('div.jsx-1221811815.search-results--products > div.jsx-200723616.search-results-4-grid.grid-pod > div.jsx-1833870204.jsx-3831830274.pod.pod-4_GRID').each((index: number, content: any) => {
